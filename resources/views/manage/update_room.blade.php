        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">修改考场</div>
                        ...
                        <form action="{{url('/roommanage/store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="show_paper"
                                       placeholder="试卷名" value="{{$room->paper_id}}" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="name" name="name"
                                       placeholder="请输入考场名" value="{{$room->name}}">
                            </div>
                            <div class="form-group">
                                <label for="remark">备注</label>
                                <input type="text" class="form-control" id="remark" name="remark"
                                       placeholder="请输入备注" value="{{$room->remark}}">
                            </div>
                            <div class="modal-footer">
                                <a href="{{url('/roommanage/rooms')}}" type="button" class="btn btn-default">关闭</a>
